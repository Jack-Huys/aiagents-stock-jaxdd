...
from main_force_ui_v2 import display_main_force_selector_v2
...
def main():
    ...
    with st.sidebar:
        ...
        with st.expander("🎯 选股板块", expanded=True):
            ...
            if st.button("💰 主力选股V2（高级）", width='stretch', key="nav_main_force_v2", help="多维度高级筛选策略"):
                st.session_state.show_main_force_v2 = True
                for key in ['show_history', 'show_monitor', 'show_config', 'show_sector_strategy',
                           'show_longhubang', 'show_portfolio', 'show_main_force', 'show_low_price_bull', 'show_news_flow', 'show_macro_analysis']:
                    if key in st.session_state:
                        del st.session_state[key]
    ...
    # 检查是否显示主力选股V2
    if 'show_main_force_v2' in st.session_state and st.session_state.show_main_force_v2:
        display_main_force_selector_v2()
        return
